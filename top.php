<?php
	$sitelink = 'http://localhost/projects/pesapalPHP';
?>
<!DOCTYPE html>
...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	...
	<!-- Style Sheets -->
    <link href="<?php echo $sitelink ?>/css/normalize.css" rel="stylesheet">
    <link href="<?php echo $sitelink ?>/css/bootstrap.css" rel="stylesheet">
    <link href="<?php echo $sitelink ?>/css/bootstrap-responsive.css" rel="stylesheet">
    <link href="<?php echo $sitelink ?>/css/style.css" rel="stylesheet">
	<link href="<?php echo $sitelink ?>/css/style_forms_validation.css" rel="stylesheet" type="text/css">
